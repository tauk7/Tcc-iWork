...
<html lang="pt-br">
  ...
  <body>
   ...
   <nav class="navbar"> <!-- topo --> 
     <a href="index.html" class="navbar-brand"><img src="imagens/logo2.png" width="200" style="position:relative;top: 0.56em;" class="navbar-logo"></a>
       ...
       <li class="lili">
        ...
        <ul class="ul1">
            ...
            <li class="li1"><a href="index.php" class="nav-link"><img src="imagens/home.png" width="35" style="margin-right:10px; margin-top:0px;"> </a> 
      ...
      <div class="conteudo" style="position: relative; top: 1.3em;">
